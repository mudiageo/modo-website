	...
	<div class="container mx-auto px-4">
		...
		<div class="mx-auto grid max-w-5xl gap-8 md:grid-cols-2">
			...
			<div class="rounded-lg bg-white p-8 shadow-lg">
				...
				<a href="{PUBLIC_MODO_APP_URL}/app" class="btn-secondary w-full text-center">Get Started</a>
			</div>
			...
			<div class="rounded-lg bg-primary-600 p-8 text-white shadow-lg">
				...
				<ul class="mb-8 space-y-4">
					...
					<a
						href="{PUBLIC_MODO_APP_URL}/auth/login?redirect=/app/settings/subscription"
