<script>
  ...
  function calculateStats() {
    ...
    stats.averageSessionLength = studySessions.length ? 
      Math.round(totalMinutes / studySessions.length) : 0;
...
<div class="max-w-4xl mx-auto space-y-6">
  <!-- Motivational Quote -->
  <div class="bg-primary-50 rounded-lg p-6 text-center" in:fade>
  ...
  <div class="grid md:grid-cols-2 gap-6">
    <!-- Weekly Progress -->
    <div class="bg-white rounded-lg shadow p-6" in:slide>
    ...
    <div class="bg-white rounded-lg shadow p-6" in:slide>
      <h2 class="text-lg font-semibold text-gray-900 mb-4">Subject Distribution</h2>
      <ProgressChart
  ...
  <!-- Recent Activity -->
  <div class="bg-white rounded-lg shadow p-6" in:slide={{ delay: 400 }}>
    ...
    {:else}
      <p class="text-gray-500 text-center py-4">No study sessions recorded yet.</p>
    {/if}
