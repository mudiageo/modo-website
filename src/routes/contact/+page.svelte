...
import { PUBLIC_MODO_APP_URL } from '$env/static/public';
	...
	async function handleSubmit() {
		try {
			const response = await fetch(`${PUBLIC_MODO_APP_URL}/api/contact`, {
				method: 'POST',
...
<div class="mx-auto max-w-4xl px-4 py-12" in:fade>
	<h1 class="mb-8 text-4xl font-bold text-gray-900">Contact Us</h1>

	<div class="grid gap-12 md:grid-cols-2">
		<div>
			<h2 class="mb-4 text-2xl font-semibold text-gray-900">Get in Touch</h2>
			<p class="mb-6 text-gray-600">
				Have questions about Modo? We're here to help! Fill out the form and we'll get back to you
				as soon as possible.
			</p>
		...
		<div class="rounded-lg bg-white p-6 shadow-sm">
			{#if status.message}
				<div
					class="mb-6 rounded-lg p-4 {status.type === 'success'
