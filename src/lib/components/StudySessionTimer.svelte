...
<div class="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800">
	...
	{#if !$activeSession}
		<div class="space-y-4" in:fade>
			...
			<button class="btn-primary w-full" onclick={handleStartSession} disabled={!subject}>
				Start Session
			</button>
		</div>
	{:else}
...
<div class="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800" in:slide>
	<h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Active Session</h2>
