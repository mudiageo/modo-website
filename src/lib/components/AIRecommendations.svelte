...
{:else}
  <div class="space-y-6" in:fade>
    <!-- Motivational Quote -->
    <div class="bg-primary-50 p-4 rounded-lg" in:slide>
      <p class="text-primary-800 italic">"{quote.text}"</p>
      <p class="text-primary-600 text-sm mt-2">— {quote.author}</p>
    </div>
    ...
    <div class="space-y-4">
      {#each recommendations as rec}
        <div 
          class="p-4 rounded-lg border-l-4 bg-white shadow-sm
