...
function formatRecommendations(predictions, userData) {
    ...
    if (userData.weekdayPatterns) {
        ...
        if (maxDayLoad > avgStudyLoad * 2) {
            recommendations.push({
                ...
                description: 'Your study load is unevenly distributed. Try to spread your study sessions more evenly throughout the week',
                priority: 'medium'
            });
        }
    }
    ...
    if (userData.completionRate < 0.7) {
        recommendations.push({
            ...
            description: 'Your task completion rate could be improved. Try setting more realistic daily goals and using a task prioritization system',
            priority: 'high'
        });
    }
    ...
    if (userData.breakFrequency > 90) {
        recommendations.push({
            ...
            description: 'Your breaks might be too frequent. Try to maintain focus for longer periods between breaks',
            priority: 'low'
        });
    }
    ...
    if (predictions[0] < 0.5) {
        recommendations.push({
            ...
            description: 'Our model suggests your current approach might need adjustment. Consider scheduling a session with a study advisor',
            priority: 'high'
        });
        ...
        recommendations.push({
            ...
            description: "You're performing exceptionally well! Consider taking on more advanced material or helping peers with their studies",
            priority: 'low'
        });
    }
    ...
    if (studyDuration > 8) {
        recommendations.push({
            ...
            description: 'Your study window might be too broad. Consider creating more focused study periods with clear objectives',
            priority: 'medium'
        });
    }
